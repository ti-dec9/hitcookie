...
<section class="relative flex items-center justify-center py-20 pt-48 lg:pt-20 lg:pl-32 bg-verdehk">
   ...
   <div class="relative z-20 px-4 flex flex-row lg:py-0 py-20 w-[750px] h-full mx-4 border-4 rounded-lg border-amarelohk lg:mx-0 lg:pr-4">
    <div class="absolute inset-x-0 -top-72 lg:-inset-y-[106px] lg:-left-60">
      <img class="lg:w-[450px] lg:h-[600px] w-[550px] h-[550px]  lg:flex drop-shadow-xl " src="https://ik.imagekit.io/jdmxypilt/HitCookie/IMG_4420-removebg__1__KHtHs_dri.png?ik-sdk-version=javascript-1.4.3&updatedAt=1672416363073" alt="" />
    </div>
